# Generated by Django 5.1.4 on 2025-01-17 11:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item_id', models.CharField(blank=True, editable=False, max_length=50, null=True, unique=True)),
                ('name', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('product', 'Product'), ('add_on', 'Add On')], default='product', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supply', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TriadApp.supply')),
            ],
            options={
